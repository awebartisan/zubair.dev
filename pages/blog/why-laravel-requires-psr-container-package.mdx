...
export const meta = {
    ...
    readTime: 3,
    url:
        'https://zubairmohsin.dev/blog/why-laravel-requires-psr-container-package',
    canonical:
        'https://zubairmohsin.dev/blog/why-laravel-requires-psr-container-package',
...
I hope you enjoyed this post. Next, we will see how Laravel uses `psr/simple-cache` package. You can follow me on [Twitter](https://twitter.com/Zubairmohsin33) or join my [newsletter](https://letter.zubairmohsin.dev) for more content.