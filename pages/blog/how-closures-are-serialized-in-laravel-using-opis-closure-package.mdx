...
export const meta = {
    ...
    readTime: 3,
    url:
        'https://zubairmohsin.dev/blog/how-closures-are-serialized-in-laravel-using-opis-closure-package',
    canonical:
        'https://zubairmohsin.dev/blog/how-closures-are-serialized-in-laravel-using-opis-closure-package',
    showDate: 'Apr 3, 2021',
...
I hope you enjoyed this post. Next, we will see how Laravel uses `psr/container` package. You can follow me on [Twitter](https://twitter.com/Zubairmohsin33) or join my [newsletter](https://letter.zubairmohsin.dev) for more content.