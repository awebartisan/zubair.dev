...
export const meta = {
    ...
    readTime: 3,
    url:
        'https://zubairmohsin.dev/blog/how-date-and-time-work-in-laravel-using-nesbot-carbon-package',
    canonical:
        'https://zubairmohsin.dev/blog/how-date-and-time-work-in-laravel-using-nesbot-carbon-package',
    showDate: 'Apr 3, 2021',
...
I hope you enjoyed this post. Next, we will see how Laravel uses `opis/closure` package. You can follow me on [Twitter](https://twitter.com/Zubairmohsin33) or join my [newsletter](https://letter.zubairmohsin.dev) for more content.