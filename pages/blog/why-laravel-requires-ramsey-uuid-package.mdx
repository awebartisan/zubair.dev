...
export const meta = {
    ...
    readTime: 3,
    url:
        'https://zubairmohsin.dev/blog/why-laravel-requires-ramsey-uuid-package',
    canonical:
        'https://zubairmohsin.dev/blog/why-laravel-requires-ramsey-uuid-package',
    showDate: 'May 2, 2021',
...
I hope you enjoyed this post. Next, we will see why Laravel requires `swiftmailer/swiftmailer` package. You can follow me on [Twitter](https://twitter.com/Zubairmohsin33) or join my [newsletter](https://letter.zubairmohsin.dev) for more content.