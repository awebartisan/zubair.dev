...
export const meta = {
    ...
    readTime: 2,
    url: 'https://zubair.dev/blog/how-i-messed-up-my-newsletter',
    canonical: 'https://zubair.dev/blog/how-i-messed-up-my-newsletter',
...
ConvertKit to the rescue again! They offer **landing pages** with many ready-to-go templates available. Also, you can use custom domains on these landing pages. That solved my subdomain problem and [letter.zubair.dev](https://letter.zubair.dev) was born.
...
I hope you find this blogpost useful. You can subscribe to the newsletter at [letter.zubair.dev](https://letter.zubair.dev) for more interesting content.
